      ...
      <div class="loading-screen-container">
        ...
        <div class="loading-historical">
          ...
          <div class="loading-historical-grid">
            <div class="loading-stat-card skeleton-box historical-card" data-delay="3">
              <div class="stat-icon">📅</div>
              <div class="skeleton-label">1_WEEK_AGO</div>
              <div class="skeleton-value"></div>
              <div class="tech-detail">LOADING ARCHIVE...</div>
            </div>
            <div class="loading-stat-card skeleton-box historical-card" data-delay="4">
              <div class="stat-icon">📆</div>
              <div class="skeleton-label">1_MONTH_AGO</div>
              <div class="skeleton-value"></div>
              <div class="tech-detail">LOADING ARCHIVE...</div>
            </div>
            <div class="loading-stat-card skeleton-box historical-card" data-delay="5">
              <div class="stat-icon">🗓️</div>
              <div class="skeleton-label">3_MONTHS_AGO</div>
              <div class="skeleton-value"></div>
              <div class="tech-detail">LOADING ARCHIVE...</div>
            </div>
            <div class="loading-stat-card skeleton-box historical-card" data-delay="6">
              <div class="stat-icon">📋</div>
