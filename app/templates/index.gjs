  ...
  <div class="container">
    <div class="header">
      ...
      <div class="contract-info">
        Contract: <strong>0x47EeF336e7fE5bED98499A4696bce8f28c1B0a8b</strong><br>
        Network: <strong>Gnosis Chain</strong>
      </div>
    </div>

    <div class="stats">
      <StatCard @label="Total Events" @value={{or @model.stats.totalEvents "-"}} />
      <StatCard 
        @label="Latest Price" 
    ...
    {{#if @model.historical}}
      <HistoricalComparison @historical={{@model.historical}} @latestPrice={{@model.stats.latestPrice}} />
    {{/if}}
